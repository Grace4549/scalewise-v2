  ...
  return (
    <div className="py-14 container mx-auto px-4 max-w-3xl prose prose-slate dark:prose-invert">
      ...
      <ul>
        ...
        <li>Facilitate communication between experts and clients.</li>
        <li>Improve our platform and user experience.</li>
      </ul>

      <h2>3. Disclosure of Your Information</h2>
      <p>We may share information we have collected about you in certain situations. Your information may be disclosed as follows:</p>
      <p><strong>To Experts/Clients:</strong> To facilitate the sessions you book, we share necessary profile and booking information with the other party.</p>
      <p><strong>Third-Party Service Providers:</strong> We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.</p>
