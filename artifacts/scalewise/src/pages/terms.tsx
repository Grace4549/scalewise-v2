export default function Terms() {
  return (
    <div className="py-14 container mx-auto px-4 max-w-3xl prose prose-slate dark:prose-invert">
      ...
      <p>Welcome to ScaleWise. These Terms of Service govern your use of our website and marketplace platform.</p>

      <h2>1. Acceptance of Terms</h2>
      <p>By accessing or using ScaleWise, you agree to be bound by these Terms. If you do not agree to these terms, please do not use our services.</p>

      <h2>2. Platform Usage</h2>
      <p>ScaleWise is a marketplace connecting business owners (Clients) with business experts (Experts) for advisory sessions. We do not provide consulting services directly; we provide the platform for you to connect.</p>
      ...
      <h2>6. Liability</h2>
      <p>ScaleWise is not responsible for the advice given by Experts. Experts provide opinions based on their experience; it is not guaranteed to produce specific financial or business results. Clients implement advice at their own risk.</p>
